...
function AddProfileCustomer(props) {
              ...
              {step === '1' ? (
                <>
                  ...
                  <Typography sx={{ fontSize: 13, fontFamily: 'Ubuntu' }}>
                    Fill all customer data information
                  </Typography>
                    ...
                    <Grid item md={6}>
                      <Box>
                        ...
                        <TextField
                          ...
                          sx={{
                            width: '100%',
                            backgroundColor: Color.GRAY2_COLOR,
                          }}
                        />
                      </Box>
                    </Grid>
                ...
                <>
                  ...
                  <Typography sx={{ fontSize: 13, fontFamily: 'Ubuntu' }}>
                    Fill all company data information
                  </Typography>
                  <Grid container spacing={2} sx={{ mt: 2 }}>
                    <Grid item md={6}>
                      <Box>
...
export default AddProfileCustomer;
